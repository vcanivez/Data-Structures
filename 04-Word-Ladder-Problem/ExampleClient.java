...
public class ExampleClient {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println(doublets.getNeighbors("ABSORBABILITIES"));
        
        // System.out.println(doublets.getLadder("cat", "can"));
        System.out.println(doublets.getLadder("cat", "zzz"));

        System.out.println(doublets.getMinLadder("cat", "zzz"));
    }
}
